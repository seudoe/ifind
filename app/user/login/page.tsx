    ...
    <>
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="text-xs text-[var(--text-3)] bg-[var(--surface)] px-3">or</span>
        </div>
      </div>
      <button
        type="button"
        onClick={() => { import("sonner").then(({ toast }) => toast.info("Google login coming soon")); }}
        className="w-full flex items-center justify-center gap-3 px-4 py-2 border border-[var(--border)] rounded-[var(--radius-sm)] text-sm text-[var(--text)] hover:bg-[var(--surface-2)] transition-colors duration-[var(--transition)]"
      >
